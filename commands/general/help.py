...
class SelectDropdown(discord.ui.Select):
    ...
    async def callback(self,interaction: discord.Interaction):
        if self.values[0] == "1":
            ...
            select_embed_2.add_field(name="/gun_lỏ", value=self.file_read("./txt_files/help/general_commands.txt",8), inline=False)
            select_embed_2.add_field(name="/hack", value=self.file_read("./txt_files/help/general_commands.txt",9), inline=False)
            select_embed_2.add_field(name="/kill", value=self.file_read("./txt_files/help/general_commands.txt",10), inline=False)
            select_embed_2.add_field(name="/lgbt", value=self.file_read("./txt_files/help/general_commands.txt",11), inline=False)
            select_embed_2.add_field(name="/momoi", value=self.file_read("./txt_files/help/general_commands.txt",12), inline=False)
            select_embed_2.add_field(name="/rate", value=self.file_read("./txt_files/help/general_commands.txt",13), inline=False)
            select_embed_2.add_field(name="/rps", value=self.file_read("./txt_files/help/general_commands.txt",14), inline=False)
            select_embed_2.add_field(name="/trongtruonghop", value=self.file_read("./txt_files/help/general_commands.txt",15), inline=False)
